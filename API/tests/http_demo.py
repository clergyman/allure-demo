...
ROUTES = {
    ...
    ('GET', '/catalog/recommendations'): (200, {'items': [{'id': 'product-2'}]}),
    ('GET', '/catalog/products/product-1/media'): (200, {'images': [{'url': 'https://demo.invalid/backpack.png'}]}),
    ...
    ('POST', '/identity/mfa/verify'): (200, {'verified': True}),
    ('POST', '/identity/token/refresh'): (200, {'token': 'demo-token', 'expires_in': 3600}),
    ('GET', '/identity/sessions'): (200, {'sessions': [{'id': 'session-1', 'expires_at': '2026-10-01T12:00:00Z'}]}),
    ...
    ('POST', '/orders/order-1/refund'): (200, {'amount': 49.99, 'currency': 'EUR'}),
    ('POST', '/orders/order-1/payment'): (200, {'authorized': True}),
    ('GET', '/orders/order-1/invoice'): (200, {'invoice': {'id': 'invoice-1', 'tax': {'rate': 0.2}}}),
}
